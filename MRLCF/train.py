...
def main():
  ...
  while step < config.steps:
    ...
    success_rate, _ = eval_driver(eval_policy, episodes=config.eval_eps)
    print('evaluation success rate: ', success_rate)
    log_success_rate.append(np.array([int(step), success_rate]))
    np.savetxt(config.success_file + '.txt', log_success_rate)
