...
class Explorer(object):
    ...
    def run_k_episodes(self, k, phase, update_memory=False, imitation_learning=False, episode=None, epoch=None,
        ...
        self.statistics = success_rate, collision_rate, outside_rate, avg_nav_time, average(cumulative_rewards), average(average_returns)
    ...
    def log(self, tag_prefix, global_step):
        sr, cr, out_r, time, reward, avg_return = self.statistics
