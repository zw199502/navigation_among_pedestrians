...
def main(args):
    ...
    if args.resume:
        ...
        il_policy.radius = robot.radius
        il_policy.max_speed = robot.v_pref
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='data/cadrl_few_il_seed_12')
    ...
    parser.add_argument('--randomseed', type=int, default=12)
