...
def main():
    ...
    parser.add_argument("--load_model", type=str, default="/models/step_60000")
    # Don't train and just run the model
    parser.add_argument("--test", default=True, action="store_true")
    # environment settings
    parser.add_argument("--complex_env", default=True, action="store_true")
    ...
    replay_buffer = memory.ReplayBuffer(
        lidar_state_dim, position_state_dim, action_dim, args.hidden_size,
